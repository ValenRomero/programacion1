...
function editar(index) {
  ...
  document.getElementById("inp_descripcion").value =
    menu_principal[index].descripcion;
...
document
  .getElementById("eliminar_lista")
  .addEventListener("click", eliminar_lista);
...
document
  .getElementById("btn_finalizar")
  .addEventListener("click", nueva_pagina);
